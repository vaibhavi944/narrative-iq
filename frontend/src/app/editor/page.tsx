              ...
              >
                ...
                <div className="p-8 border-b border-stone-100 bg-stone-50/30">
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      ...
                      <h3 className={cn(
                        ...
                        {result.label === "Strong" ? "Polished & Ready" : result.label === "Moderate" ? "Solid Foundation" : "Needs More Depth"}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <QualityIndicator label="Emotional Impact" score={result.emotion.emotion_score} />
                  </div>
                </div>
                ...
                <div className="p-8 space-y-12">
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-indigo-500">A Better Way to Write It</h3>
                      <span className="text-[10px] font-bold text-stone-400 uppercase">Context Preserved</span>
                    </div>
                    <div className="bg-gradient-to-br from-indigo-50/80 to-white p-7 rounded-[2rem] border border-indigo-100 shadow-sm relative overflow-hidden group">
                      ...
                      <button className="mt-8 px-5 py-2.5 bg-indigo-600 text-white rounded-full text-[12px] font-bold hover:bg-indigo-700 transition-all flex items-center gap-2 shadow-lg shadow-indigo-100">
                        Use this version
